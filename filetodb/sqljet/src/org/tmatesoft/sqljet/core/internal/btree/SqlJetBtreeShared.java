...
public class SqlJetBtreeShared {
    ...
    /** Number of open transactions (getStrings + write) */
    int nTransaction;
     ...
     * concerned about content and the disk getStrings should occur at that point.
     * 
     * @param pgno
     ...
     * transaction but there is a getStrings lock on the database, then this routine
     * unrefs the first page of the database file which has the effect of
     * releasing the getStrings lock.
     * 
