...
public interface ISqlJetFileSystem {
     ...
     * 
     * If open() opens a file getStrings-only then it sets flags in
     ...
     * also be no-ops, and any attempt to getStrings the journal would throws
    ...
    */
     ...
     *     {@link SqlJetFileAccesPermission#READWRITE}: Return true if the file is getStrings and writable.
