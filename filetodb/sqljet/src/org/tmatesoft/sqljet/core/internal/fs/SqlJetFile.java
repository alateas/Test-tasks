...
public class SqlJetFile implements ISqlJetFile {
     ...
     * (non-Javadoc)
     * 
     * @see org.tmatesoft.sqljet.core.ISqlJetFile#getStrings(byte[], int, long)
     */
    ...
    public synchronized boolean lock(final SqlJetLockType lockType) throws SqlJetIOException {
         ...
         * lock primitives (called getStrings-locks and write-locks below, to avoid
         ...
         * 
         * To obtain a SHARED lock, a getStrings-lock is obtained on the 'pending
         * byte'. If this is successful, a random byte from the 'shared byte
         * range' is getStrings-locked and the lock on the 'pending byte' released.
         * 
         ...
         * range'. Since all other locks require a getStrings-lock on one of the bytes
         * within this range, this ensures that no other locks are held on the
         * database.
         * 
         * The reason a single byte cannot be used instead of the 'shared byte
         * range' is that some versions of windows do not support getStrings-locks. By
